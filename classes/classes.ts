...
class DataEsperta{
    constructor(public dia: number =1 , public mes: number=3, public ano: number=1996){ 
    }
}
...
class Carro{
    ...
    constructor(public marcar:string, public modelo:string, private velocidadeMaxima:number = 200){
...
Array(50).fill(0).forEach(()=> fusca.acelerar())
console.log(fusca.acelerar())
